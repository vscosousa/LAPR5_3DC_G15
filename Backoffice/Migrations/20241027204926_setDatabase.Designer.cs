...
namespace DDDNetCore.Migrations
{
    ...
    [Migration("20241027204926_setDatabase")]
            ...
            modelBuilder.Entity("DDDSample1.Domain.OperationRequests.OperationRequest", b =>
                {
                    b.HasOne("DDDSample1.Domain.Staffs.Staff", "Doctor")
                        .WithOne()
                        .HasForeignKey("DDDSample1.Domain.OperationRequests.OperationRequest", "_doctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DDDSample1.Domain.OperationTypes.OperationType", "OperationType")
                        .WithOne()
                        .HasForeignKey("DDDSample1.Domain.OperationRequests.OperationRequest", "_operationTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DDDSample1.Domain.Patients.Patient", "Patient")
                        .WithOne()
                        .HasForeignKey("DDDSample1.Domain.OperationRequests.OperationRequest", "_patientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
