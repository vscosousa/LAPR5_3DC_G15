...
namespace DDDSample1.Domain.OperationTypes
{
    public class OperationTypeService
    {
        ...
        public OperationTypeService(IUnitOfWork unitOfWork, IOperationTypeRepository repository, ISpecializationRepository specializationRepository, IStaffRepository staffRepository, IOperationTypeMapper mapper, IStaffMapper staffMapper)
        {
